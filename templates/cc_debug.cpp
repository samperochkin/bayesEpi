  ...
  Type objective_function<Type>::operator() ()
{
  ...
  Type log_pi_z = 0;
  if(block_to_run(3) == 1){
    if(z_dim != 0) log_pi_z += dnorm(z, Type(0), 1/sqrt(theta(theta_dim-1)), true).sum();
  }
  ...
  Type nll = -log_likelihood - log_pi_beta - log_pi_gamma - log_prior_theta;
  return nll;
  }
