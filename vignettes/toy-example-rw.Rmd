---
title: "Toy example (random walk model)"
...
This vignette shows hot to use the `fitModel` function to fit a case crossover model with RW2 models for the random effects.
